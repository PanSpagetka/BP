...
def genBackButton(pagesToRender, caseName = None):
	...
	formStr += '<input type="submit" value="Back" class="btn btn-default"></a></div></form>'
	return formStr
...
def genBootstrapJS():
	return '<script src="https://code.jquery.com/jquery-1.11.3.min.js"></script><script src="bootstrap/js/bootstrap.min.js"></script><script src="https://cdn.datatables.net/1.10.10/js/jquery.dataTables.min.js"></script><script src="js/script.js"></script>'
